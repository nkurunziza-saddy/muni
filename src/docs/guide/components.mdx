...
// [!include ~/src/snippets/example.ts:import]

// [!include ~/src/snippets/example.ts:setup]
```
...
````ts // [!code focus]
// [!code highlight:1]
// [!include ~/src/snippets/example.ts]  // [!code focus]
``` // [!code focus]
...
// [!include ~/src/snippets/example.ts:import] // [!code focus]

// [!include ~/src/snippets/example.ts:setup] // [!code focus]

// [!include ~/src/snippets/example.ts:usage] // [!code focus]
...
// [!include ~/src/snippets/example.ts:usage-1]
...
```ts
import { writeFileSync } from "node:fs";
// [!include ~/src/snippets/example.ts /viem/@viem\/core/ /mainnet/sepolia/] // [!code focus]
...
```ts
import { writeFileSync } from "node:fs";
// [!include ~/src/snippets/example.ts:import /viem/@viem\/core/ /mainnet/sepolia/]

// [!include ~/src/snippets/example.ts:setup /mainnet/sepolia/]
...
(`// [!code highlight]`)](:1/
We can also include markers like [line highlight docs/markdown#line-highlights) in our code snippets.
...
// [!include ~/src/snippets/example.ts:usage-2-docs]
```

````md [example.md]
```ts
import { writeFileSync } from "node:fs";
// [!include ~/src/snippets/example.ts]
...
// [!include ~/src/snippets/example.ts:usage-2]
...
// [!include ~/src/snippets/example.ts:usage-4]
```
